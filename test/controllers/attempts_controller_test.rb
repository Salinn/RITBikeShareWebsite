...
class AttemptsControllerTest < ActionController::TestCase
  ...
  test "should create attempt" do
    assert_difference('Attempt.count') do
      post :create, attempt: { score: @attempt.score, survey_id: @attempt.survey_id, user_id: @attempt.user_id }
    end
  ...
  test "should update attempt" do
    patch :update, id: @attempt, attempt: { score: @attempt.score, survey_id: @attempt.survey_id, user_id: @attempt.user_id }
    assert_redirected_to attempt_path(assigns(:attempt))
  end
